...
function TooltipView:didMount()
	...
	self.steppedConn =
		self:_runRunServiceEvent():Connect(
		function()
...
function TooltipView:render()
	...
	children.ObjectDesc =
		...
		},
		{
			...
			InstanceClass = Roact.createElement(
				TextLabel,
				{
			...
			InstanceName = Roact.createElement(
				TextLabel,
				{
	...
	return Roact.createElement(
		...
		{
			TagEditorTooltip = Roact.createElement(
				"ScreenGui",
				{
				...
				},
				{
					Window = Roact.createElement(
						...
						{
							HorizontalDivider = Roact.createElement(
								"Frame",
								{
							...
							VerticalDivider = Roact.createElement(
								"Frame",
								{
